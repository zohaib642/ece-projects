...
## Switches
set_property PACKAGE_PIN V17 [get_ports {time_value[0]}]	
	set_property IOSTANDARD LVCMOS33 [get_ports {time_value[0]}]    
set_property PACKAGE_PIN V16 [get_ports {time_value[1]}]			
	set_property IOSTANDARD LVCMOS33 [get_ports {time_value[1]}]    
set_property PACKAGE_PIN W16 [get_ports {time_value[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {time_value[2]}]
set_property PACKAGE_PIN W17 [get_ports {time_value[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {time_value[3]}]
set_property PACKAGE_PIN W15 [get_ports {time_value[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {time_value[4]}]
set_property PACKAGE_PIN V15 [get_ports {time_value[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {time_value[5]}]
set_property PACKAGE_PIN W14 [get_ports {time_value[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {time_value[6]}]
set_property PACKAGE_PIN W13 [get_ports {time_value[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {time_value[7]}]
